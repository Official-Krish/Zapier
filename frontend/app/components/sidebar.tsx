...
export const Sidebar = () => {
    return <div>
            ...
            <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg group pt-6">
                <PrimaryButton size="large" logo={<Plus/>} onClick={() => { }}>
                    Create
                </PrimaryButton>
                </a>
            </li>
            ...
            <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lghover:bg-gray-100  group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-lg">Zaps</span>
                </a>
            </li>
            <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-lg">Tables</span>
                </a>
            </li>
            ...
            <li>
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-lg">Products</span>
                </a>
            </li>
            <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-lg">Log In</span>
                </a>
            </li>
            <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-lg">Sign Up</span>
                </a>
            </li>
        </ul>
    </div>
